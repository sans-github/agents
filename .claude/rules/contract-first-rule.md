...
This rule governs **agent-to-agent technical contracts** only. Human milestone gates (PRD, Mocks, Sys Arch, Implementation Plan, Kickoff Plan) are defined per-project in section 5 of the kickoff plan -- not here.
...
Human milestone gates are defined in section 5 of `workflow/kickoff-plan.md` for each project. When an agent completes work that produces a section 5 checkpoint artifact, it must:
