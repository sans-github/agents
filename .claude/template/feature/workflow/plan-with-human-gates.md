<!-- Seeded by the orchestrator at kickoff. Progressively filled by EM as decisions are made. -->
...
- [ ] 3. **[EM]** → PM→EM handoff, evaluate arch engagement, add next steps to this doc

<!-- EM fills in remaining steps progressively from here: arch (if needed), HLD, -->
<!-- detailed implementation plan, and a 👤 human gate before execution begins. -->
